...
function App() {
  ...
  // Background Options
  const backgrounds = [
    { id: 'tree', src: getImagePath('minimal_tree.png'), label: 'Nature', type: 'far' },
    { id: 'street', src: getImagePath('india_street.png'), label: 'Street', type: 'far' },
    { id: 'interior', src: getImagePath('modern_interior.png'), label: 'Interior', type: 'mid' },
    { id: 'people', src: getImagePath('portrait_group.png'), label: 'People', type: 'mid' },
    { id: 'animal', src: getImagePath('golden_retriever.png'), label: 'Animal', type: 'close' },
    { id: 'book', src: getImagePath('open_book_reading.png'), label: 'Reading', type: 'near' },
    // New Scenes
    { id: 'beach', src: getImagePath('scene_beach.png'), label: 'Beach', type: 'far' },
    { id: 'night', src: getImagePath('scene_night_city.png'), label: 'Night City', type: 'far' },
    { id: 'forest', src: getImagePath('scene_forest.png'), label: 'Forest', type: 'far' },
    { id: 'snow', src: getImagePath('scene_snow.png'), label: 'Snow', type: 'mid' },
  ];
